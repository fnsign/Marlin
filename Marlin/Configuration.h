...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, SKR-mini-E3-V1.2)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -11, 0 } //was prior: #define NOZZLE_TO_PROBE_OFFSET { -44, -14, 0 }, { 56, -33, 0 }, { -44, -6, 0 }
...
#define LCD_BED_TRAMMING
  ...
  //#define BED_TRAMMING_USE_PROBE
    ...
    #define BED_TRAMMING_PROBE_TOLERANCE 0.02  // (mm) was originally 0.1
