...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kd  65.53 // was default 76.55
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 69.52 // was default 50.71
  #define DEFAULT_bedKi 13.58 // was default 9.88
  #define DEFAULT_bedKd 237.29 // was default 173.43
...
#define X_MIN_POS -5 // was default 0
#define Y_MIN_POS -10 // was default 0
=======
// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
>>>>>>> 8fb65211fc3bd55db9aac2145d327aad3d5d547d
#define Z_MIN_POS 0
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 30, 30, 30 } // (mm) Left, Front, Right, Back insets, was originally (30, 30, 30, 30)
  #define LEVEL_CORNERS_HEIGHT      0.1   // (mm) Z height of nozzle at leveling points
  #define LEVEL_CORNERS_Z_HOP       4.0   // (mm) Z height of nozzle between leveling points
  //#define LEVEL_CENTER_TOO              // Move to the center after the last corner
  //#define LEVEL_CORNERS_USE_PROBE
  #if ENABLED(LEVEL_CORNERS_USE_PROBE)
    #define LEVEL_CORNERS_PROBE_TOLERANCE 0.02 // is originally 0.1
...
//
#define PREHEAT_1_LABEL       "Filament Chg."
...
#define PREHEAT_4_LABEL       "Bed Leveling"
